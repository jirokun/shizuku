...
var scm = new _ShizukuComponentManager2.default({
  components: [{
    ...
    label: '属性追加',
    children: [{ label: '優先順に定数値追加', constructor: _AddAttributeByEntryOrder2.default }, { label: '月毎の取引数追加', constructor: _TransactionByMonthComponent2.default }, { label: '従業員がリストに含まれているか', constructor: _EmployeeIsInListComponent2.default }, { label: '期間内の取引数', constructor: _DesignatingPeriodsTransactionComponent2.default }]
  }, {
    label: '出力',
