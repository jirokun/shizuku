...
var AddAttributeByEntryOrderComponent = function (_DecorateComponent) {
  _inherits(AddAttributeByEntryOrderComponent, _DecorateComponent);

  function AddAttributeByEntryOrderComponent() {
    var _Object$getPrototypeO;

    _classCallCheck(this, AddAttributeByEntryOrderComponent);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    var _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(AddAttributeByEntryOrderComponent)).call.apply(_Object$getPrototypeO, [this].concat(args)));

    _this.row = ['']; // 描画のためのデータ
    return _this;
  }

  _createClass(AddAttributeByEntryOrderComponent, [{
    key: 'buildTitle',
    ...
    value: function setValue(value) {
      ...
      _get(Object.getPrototypeOf(AddAttributeByEntryOrderComponent.prototype), 'setValue', this).call(this, value);
    }
  }, {
    key: 'deleteRow',
    ...
    value: function getOutputFields() {
      ...
      outputFields.push.apply(outputFields, _toConsumableArray(this.getOriginalOutputFields()));
      return outputFields;
    }
  }, {
    key: 'buildSQL',
    value: function buildSQL() {
      ...
      var usedFields = this.getOutputFields();
      ...
      sql += sourceComponents.map(function (c, i) {
        var id = c.getId();
        var sqlInner = 'select ';
        sqlInner += usedFields.map(function (f) {
  ...
  return AddAttributeByEntryOrderComponent;
}(_DecorateComponent3.default);

exports.default = AddAttributeByEntryOrderComponent;