...
var DebugSQLComponent = function (_OutputComponent) {
  _inherits(DebugSQLComponent, _OutputComponent);

  function DebugSQLComponent() {
    var _Object$getPrototypeO;

    _classCallCheck(this, DebugSQLComponent);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(DebugSQLComponent)).call.apply(_Object$getPrototypeO, [this].concat(args)));
  }

  _createClass(DebugSQLComponent, [{
    key: 'buildTitle',
    ...
    value: function componentDidMount() {
      _get(Object.getPrototypeOf(DebugSQLComponent.prototype), 'componentDidMount', this).call(this);
    ...
    value: function execute(sql) {
      var dataURI = "data:application/octet-stream," + encodeURIComponent(sql);
  ...
  return DebugSQLComponent;
}(_OutputComponent3.default);

exports.default = DebugSQLComponent;